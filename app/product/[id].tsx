...
import { Avatar, Button, H1, H2, H3, H5, H6, Image, Paragraph, ScrollView, Separator, SizableText, Tabs, TabsContentProps, XStack, YStack } from "tamagui";
                ...
                <XStack>
                    ...
                    <YStack flex={0.6}>
                        ...
                        <Paragraph textAlign="left" theme={"alt2"}>
                            Mr. Gote is a master woodcarver with over 25 years of experience. His works are renowned for their intricate details and cultural significance, reflecting the rich heritage of Balinese art.
                        </Paragraph>
                    </YStack>
                </XStack>
                <Button width={"100%"} my="$4">Visit Profile</Button>
            </TabsContent>
        </Tabs>
    )
}
        ...
        <ScrollView>
            <YStack padding="$5">
                ...
                <XStack gap="$3" justifyContent="flex-start" alignItems="center">
                    <Paragraph fontSize={"$5"} fontWeight={"bold"} theme={"alt2"}>Burari, Uttar Pradesh</Paragraph>
                    <Separator rotate="10deg" vertical height={"80%"} />
                    <Paragraph>Clothing</Paragraph>
                </XStack>

                <Image
                    source={{ uri: "https://arunakullu.com/wp-content/uploads/2024/01/71F3Vs3jiuL._SY741_.jpg" }}
                    width={"100%"}
                    height={550}
                ...
                <SizableText fontSize={"$10"} lineHeight={"$10"}>₹23,000</SizableText>

                <HorizontalTabs />

                <YStack>
                    <H3 mb="$2">Explore similar artisans</H3>
                    <Paragraph theme={"alt2"} lineHeight={"$1"}>These are some artisan belonging to the Burari, Uttar Pradesh District selling similar products.</Paragraph>
